...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("ᴜsᴇ ᴄᴏʀʀᴇᴄᴛ ғᴏʀᴍᴀᴛ \nᴇxᴀᴍᴘʟᴇ <code>/batch https://t.me/Filmly_Era3 https://t.me/guardians_Bot_Updates8</code>.")
    links = message.text.strip().split(" ")
    if len(links) != 3:
        return await message.reply("ᴜsᴇ ᴄᴏʀʀᴇᴄᴛ ғᴏʀᴍᴀᴛ \nᴇxᴀᴍᴘʟᴇ <code>/batch https://t.me/guardians_Bot_Updates3 https://t.me/guardians_Bot_Updates8</code>.")
